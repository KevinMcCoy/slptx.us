...
<head>
	...
	<script>
		...
		;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"adbc039569",applicationID:"17508782",sa:1,agent:"js-agent.newrelic.com/nr-892.min.js"}
	</script>
	<!-- [END] NewRelics -->
